...
var main = L.tileLayer.main(`${layers}/map_squares/{mapId}/{zoom}/{plane}_{x}_{y}.png`, {
    minZoom: -4,
    maxNativeZoom: 3,
    maxZoom: 4,
    iconMode: "",
...
var icons = L.tileLayer.main(`${layers}/icon_squares/{mapId}/{zoom}/{plane}_{x}_{y}.png`, {
    minZoom: -4,
    maxNativeZoom: 3,
    maxZoom: 4,
    iconMode: "",
